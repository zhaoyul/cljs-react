...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26498 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26498(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26500 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26500(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26501 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26501(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26505 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26505(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26506 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26506(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26507 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26507(reader);
}
});
...
var G__26584 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26585 = s.append(c);
c = G__26584;
s = G__26585;
continue;
}
