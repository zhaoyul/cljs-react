...
if((i < len)){
var k = (ks[i]);
var G__37468 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__37469 = (i + (1));
m = G__37468;
i = G__37469;
continue;
...
return G__37377__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37380 = c;
var G__37380__$1 = (((G__37380 == null))?null:G__37380.prototype);
if((G__37380__$1 == null)){
return null;
} else {
return G__37380__$1.render;
}
})() == null)))));
});
...
var G__37390 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__37390) : reagent.impl.component.as_element.call(null,G__37390));
};
...
var G__37394 = c;
var G__37394__$1 = (((G__37394 == null))?null:G__37394.constructor);
if((G__37394__$1 == null)){
return null;
} else {
return G__37394__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__37395 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37396 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37396);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37395);
}});
...
var c = this;
var G__37424_37480 = goog.object.get(c,"cljsRatom");
if((G__37424_37480 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37424_37480);
}
...
var renders_37484 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_37485 = cljs.core.first(cljs.core.vals(renders_37484));
...
if((cljs.core.count(renders_37484) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37484))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37485)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37485], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__37460 = o;
goog.object.set(G__37460,cljs.core.name(k),v);
