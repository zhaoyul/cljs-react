...
var G__37471 = o;
goog.object.set(G__37471,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37476 = o;
goog.object.set(G__37476,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__37517__i < G__37517__a.length) {G__37517__a[G__37517__i] = arguments[G__37517__i + 0]; ++G__37517__i;}
  args = new cljs.core.IndexedSeq(G__37517__a,0,null);
} 
...
var G__37478 = props;
var G__37478__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37478,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37478);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37478__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__37478__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37479 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37479,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37479;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37481){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37482__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__37486_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37486_SHARP_);
}));
} else {
return null;
}
...
var vec__37488 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37488,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37488,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37488,(2),null);
...
var temp__5739__auto___37542 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37542 == null)){
} else {
var key_37543 = temp__5739__auto___37542;
(jsprops.key = key_37543);
}
...
var temp__5739__auto___37544 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37544 == null)){
} else {
var key_37545 = temp__5739__auto___37544;
(jsprops.key = key_37545);
}
...
var G__37492 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37492) : reagent.impl.template.as_element.call(null,G__37492));
} else {
var temp__5739__auto___37546 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___37546 == null)){
} else {
var key_37547 = temp__5739__auto___37546;
(jsprops.key = key_37547);
}
...
var G__37494 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__37494)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__37494)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37495){
var G__37496 = cljs.core.first(seq37495);
var seq37495__$1 = cljs.core.next(seq37495);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37496,seq37495__$1);
}));
...
break;
default:
var G__37552 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37552;
continue;
...
var ctx = ({});
var vec__37499 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37499,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37499,(1),null);
...
var G__37502 = (cljs.core.count(argv) - first_child);
switch (G__37502) {
case (0):
