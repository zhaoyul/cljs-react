...
return html_coll.item(p1__35783_SHARP_);
...
return cljs.core.some((function (p1__35785_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__35785_SHARP_);
...
var ctx_35815 = cvs.getContext("2d");
(ctx_35815.fillStyle = color);

ctx_35815.fillRect((0),(0),size,size);
